  ...
  return (
    <>
      ...
      ${showCookieConsent ? "block" : "hidden"} mb-5`}>
        <p className="text text-sm mb-1">Durch die Nutzung dieser Website erklären Sie sich automatisch mit der Verwendung von Cookies und unseren Datenschutzrichtlinien einverstanden.</p>
